...
# Constructors
- `LcmCell(id::Int, vertex_ids::Tuple{Int, Int, Int}, vertices::Vector{Point3{Float64}}, center::Point3{Float64}, part_id::Int, num_neighbours::Int, neighbour_ids::Vector{Int}, thickness::Float64, area::Float64, volume::Float64, permeability::Float64, porosity::Float64, ap::Float64, cp::Float64, alpha::Float64, reference_direction::Point3{Float64}, type::CELLTYPE)`: Constructs a `LcmCell` object with all the required fields.
- `LcmCell(id::Int, vertex_ids::Tuple{Int, Int, Int}, vertices::Vector{Point3{Float64}}, center::Point3{Float64}, part_id::Int, num_neighbours::Int, neighbour_ids::Vector{Int}, thickness::Float64, area::Float64, volume::Float64, permeability::Float64, porosity::Float64, ap::Float64, cp::Float64, alpha::Float64, reference_direction::Point3{Float64})`: Constructs a `LcmCell` object without the `type` field.
